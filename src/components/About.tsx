  ...
  return (
    <div  >
      ...
      <section className="process-sec-2 overflow-hidden">
        <div className="container">
          <div
            className="process-sec-2-container-wrap bg-gradient-to-r from-amber-500 via-yellow-500 to-green-700 text-cross-xs"
                  ...
                  <div className="row gy-40 justify-content-center items-center ">
                    {finalProcessSteps.map((step, index) => (
                      ...
                      >
                        ...
                        >
                          <div className="box-img bg-gradient-to-r from-amber-500 via-yellow-500 to-green-700">
